#!/usr/bin/env python3
"""Perspective-warp an image or video into a tracked monitor surface."""
...
def main() -> int:
    ...
    parser.add_argument("input", type=Path, help="base video containing the monitor")
    ...
    parser.add_argument("--edge-inset", type=int, default=2)
    parser.add_argument("--feather", type=float, default=1.2)
    parser.add_argument("--fade-in", type=int, default=3)
    parser.add_argument("--fade-out", type=int, default=5)
    ...
    print(
        ...
        f"fps={fps:g} output={args.output}"
    )
    return 0
