...
import silent from './trailer-v2-manifest.json';
import voiced from './trailer-voice-manifest.json';
...
export const TrailerV2=()=> <Film voice={false}/>;
export const TrailerVoice=()=> <Film voice={true}/>;
