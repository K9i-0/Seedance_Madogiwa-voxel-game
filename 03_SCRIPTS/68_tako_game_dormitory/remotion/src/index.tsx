...
import FilmV2 from './V2';
import mV2 from './edit-manifest-v2.json';
...
registerRoot(()=> <><Composition component={Film} {...m.composition}/><Composition component={FilmV2} {...mV2.composition}/></>);
