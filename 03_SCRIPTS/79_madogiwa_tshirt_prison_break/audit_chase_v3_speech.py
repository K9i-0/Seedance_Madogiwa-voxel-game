...
p=EP/json.loads((EP/'wan3_chase_v3_config.json').read_text())['output']
...
(EP/'remotion/out/asr-chase-v3.json').write_text(json.dumps({'note':'Automated screening only; short music segments may hallucinate words.','clips':results},ensure_ascii=False,indent=2)+'\n')
