...
PROPS="There is exactly ONE drinking vessel in the entire frame: a single EMPTY transparent drinking glass, a plain straight-sided tumbler with NO handle, containing absolutely NOTHING: no beer, no amber liquid, no froth, no foam. There is NO second glass, NO tumbler, NO cup and NO bottle anywhere, and NO liquid of any kind is visible anywhere in the frame; nobody drinks, lifts or pours anything. Exactly THREE empty aluminium cans in the ENTIRE frame, grouped together on the far LEFT of the desk: two crushed and lying on their sides plus one upright — three cans in total, never more and never fewer. Do NOT add any new cans anywhere: there are NO cans near the laptop, NO cans on the right half of the desk, and NO cans anywhere else in the frame. Yametaro sits on a seat behind the corrugated cardboard desk with a stack of cardboard boxes beside him. The desk is plain corrugated cardboard."
