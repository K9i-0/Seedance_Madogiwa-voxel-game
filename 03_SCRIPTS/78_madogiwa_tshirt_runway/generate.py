...
record = {'model':'wan3.0-video','generation_seconds':27,'final_seconds':30,'resolution':'480P','estimated_usd':0.945,'standard_usd':1.35,'endpoint':wan.SUBMIT_URL}
...
def logged(url, api_key, **kwargs):
    ...
    return result
wan.api_json = logged
sys.argv = [sys.argv[0], str(EP/'wan3_config.json'), *sys.argv[1:]]
