...
rows=[]
for start,end,lang in [(0,10,'ja'),(10,17,'ja'),(17,21,'ja'),(21,27,'ja'),(27,33,'ja'),(33,36,'ja'),(36,40,'ja')]:
 b=subprocess.check_output(['ffmpeg','-v','error','-ss',str(start),'-t',str(end-start),'-i',str(r/'joined_wan_v2_480p.mp4'),'-f','f32le','-ac','1','-ar','16000','-'])
...
(r/'remotion/out/dialogue_screening_v2.json').write_text(json.dumps({'note':'Automatic ASR without expected text prompt, not direct listening.','segments':rows},ensure_ascii=False,indent=2)+'\n')
