...
for start,end,lang in [(0,7,'ja'),(7,12,'ja'),(15,19,'ja'),(19,23.5,'ja'),(23.5,27.5,'ja'),(27.5,30,'ja'),(30,35.5,'ja'),(35.5,39,'ja'),(39,42,'ja'),(42,45,'ja')]:
 b=subprocess.check_output(['ffmpeg','-v','error','-ss',str(start),'-t',str(end-start),'-i',str(r/'joined_wan_v4_480p.mp4'),'-f','f32le','-ac','1','-ar','16000','-'])
...
(r/'remotion/out/dialogue_screening_v4.json').write_text(json.dumps({'note':'Automatic ASR without expected text prompt, not direct listening.','segments':rows},ensure_ascii=False,indent=2)+'\n')
