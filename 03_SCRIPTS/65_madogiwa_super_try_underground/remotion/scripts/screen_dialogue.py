...
rows=[]
for start,end,lang in [(0,10,'ja'),(10,21,'ja'),(21,27,'ja'),(27,36,'ja'),(36,40,'ja')]:
 b=subprocess.check_output(['ffmpeg','-v','error','-ss',str(start),'-t',str(end-start),'-i',str(r/'joined_wan_480p.mp4'),'-f','f32le','-ac','1','-ar','16000','-'])
