...
- **[そば屋のオフィス更地クラッシュ ～全部壊して快適です！～](10_OFFICE_DEMOLITION_GAME/README.md)** (`10_OFFICE_DEMOLITION_GAME/`): 机、設備、壁、床、コンクリート柱、鉄骨を5段階で解禁し、約300件の破壊対象を残さず更地へ戻す独立型3Dアクション。支持構造の連鎖崩壊、家具投擲、進行保存、PC・ゲームパッド・スマホ操作に対応。旧オフィスクラッシュとは別作品。
