...
`v3_20260917/sobaya.glb` は承認済みWan全身モデルの姿勢補正・24骨リグ版。既存103クリップとジョッキソケットを引き継ぐ。ゲームの相対symlinkと歩走速度を更新。[制作記録](../characters/sobaya/rig_v3_20260917/README.md)。福ちゃんは従来版を維持。
