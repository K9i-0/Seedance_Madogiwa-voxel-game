...
ゲーム正本は `rig_v1/fukuchan.glb`。身長1.7m、24,857三角面、1材質、23骨、5クリップ（Idle / Walk / Run / Aim / AimShotgun）。カラー4K、その他PBR2K。GunSocketへ共通の銃モデルを装着する。

Walk / Runは手元のMixamoダウンロードを骨格へ転写。足の接地高と頭の正面向きを補正し、ゲーム移動速度へ再生速度を合わせる。Aimは両腕IKで作った構え。指ボーンはなく、指の個別把持、反動・装填の専用モーション、足の実時間IKは今後の改善対象。
