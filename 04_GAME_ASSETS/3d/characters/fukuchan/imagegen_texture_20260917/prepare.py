...
views=[('front',(0,-1,0)),('left',(.9,-.7,0)),('right',(-.9,-.7,0)),('back',(0,1,0))]
...
(OUT/'projection.json').write_text(json.dumps({'target':[0,0,1.54],'scale':.38,'views':views,'panel_size':1024},indent=2)+'\n')
print('PREPARED')
