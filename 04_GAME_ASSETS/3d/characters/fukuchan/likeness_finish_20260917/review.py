...
MODE=sys.argv[sys.argv.index('--')+1] if '--' in sys.argv else 'final'
path=OUT.parent/'shallow_face_20260917/fukuchan_balanced.glb' if MODE=='baseline' else OUT/('fukuchan_'+MODE+'.glb')
