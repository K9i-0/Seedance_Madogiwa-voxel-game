...
[握り版](../grip_v3_20260917/README.md)に、元の手の形状・爪・肌を活かした `MugGrip` モーフと、持ち手への接触補正を追加。編集用Blenderと103クリップ付きGLBを独立して保存した。本ディレクトリと本編・公式サイトの配布モデルは引き続き未変更。構え、歩走時の手首方向、攻撃演出の改訂は次工程。
