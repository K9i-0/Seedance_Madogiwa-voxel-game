...
画像ファイル：Yametaro.jpg
動画用通常シート：`03_SCRIPTS/00_TEMPLATES/characters/character_yametaro_basic_sheet.png`。2026-09-09更新の輪郭線なし・発話口形差分付き版を使う。閉じ口とA/I/U/E/Oの6種を含み、口は固定の笑顔模様ではなく、音声に合わせて口内が見える開口・顎の上下を行う。差分は発話の参考であり、表情を6種に制限しない。原画の黒い輪郭線を立体の黒い帯・板として再現せず、頬・耳・顎・うなじは肌色の連続した面として描く。黒髪と黒い丸眼鏡は維持し、シート以上に可愛さや頭身を誇張しない。過去制作の入力画像は履歴として維持する。
