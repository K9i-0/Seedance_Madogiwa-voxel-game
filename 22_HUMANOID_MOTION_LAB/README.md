...
そば屋ハザードのリアル頭身モデルを使う独立したmacOSアニメーション比較アプリ。**そば屋72・福ちゃん67クリップ、4手法**を収録。
...
「体格からIK生成」の先頭に前方ローリング。「公開動作 + IK」の先頭に、そば屋の正典ジョッキ構え・保持走行・正面パンチ・横フック・重い打ち下ろしを表示する。ジョッキ用5本はそば屋専用で、福ちゃんには「未収録」を表示する。しゃがみ等の視線も修正済み。
