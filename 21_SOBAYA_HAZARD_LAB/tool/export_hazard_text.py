...
def build(previous, force_ocr):
    ...
    return {
        ...
        "scope": {
            ...
            "readOrder": ["runtimeStory.events", "runtimeStory.tutorial", "runtimeStory.dialogueTrees", "runtimeStory.dialogueStarts", "runtimeStory.resolvedDialogueVariants",
            ...
            "stableIds": "会話はowner/topic/index、イベントはevent/index、序章の声かけはtutorial/step、メモ/画像/資料は既存キー。sourceTextはファイル/宣言名/文字列順で、文言の修正や無関係な行の追加では変わらない。同じ宣言への文字列挿入は後続番号を変える。",
