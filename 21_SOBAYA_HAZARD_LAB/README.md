...
最新Mac版（アイコンC・日本語アプリ名、ソース `091fbbc`）: [そば屋ハザード.app](../.local/hazard_releases/sobaya-hazard-macos-091fbbc/そば屋ハザード.app) / [ZIP](../.local/hazard_releases/sobaya-hazard-macos-091fbbc.zip)。配布ファイルからの起動、Cアイコンの同梱ハッシュ、署名・ZIP検査を確認済み。以下の配布リンクは各更新時点の履歴。
