...
for name in ['sobaya','fukuchan']:
    ...
    for spec in profile['clips']:
        ...
        if spec['method'] in ['hybrid','procedural','video','videoRig'] and min(floors)<-.002:
        ...
        if spec['loop'] and spec['method'] in ['hybrid','procedural','video','videoRig'] and (seam_angle>.12 or seam_translation>.012):
