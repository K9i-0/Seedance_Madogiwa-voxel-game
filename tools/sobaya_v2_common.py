"""Shared paths, import, neutral studio and geometry utilities for Sobaya v2."""
...
OUT = ROOT / '04_GAME_ASSETS/3d/characters/sobaya/v2_20260913'
...
def studio():
    ...
    world=bpy.data.worlds.new('SobayaV2Studio')
