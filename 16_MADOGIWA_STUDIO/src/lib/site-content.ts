...
export const comicEpisodes = [
  ...
  { title: "正体バレ", description: "よーたんが怪しい男を指名手配中のやめ太郎だと見破る。そば屋は我関せず、ビールを飲みながら木材を運ぶ。" },
  { title: "逃走", description: "やめたろうが赤坂の街を全力逃走。そば屋もジョッキを6個抱えたまま「ついでに」逃げ、とーくんは演奏を続ける。" },
  { title: "タコ部屋に連行", description: "2人はついに確保され、タコ部屋へ。そば屋はタイピング、やめたろうは電話対応という強制労働が始まる。" },
  { title: "脱走", description: "よーたんが差し入れを持って訪ねると、壁には巨大な人型の穴。そば屋とやめたろうは壁を破って脱走していた。" },
