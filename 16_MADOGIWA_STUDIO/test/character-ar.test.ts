...
import { arCharacters, arHeight } from "../src/official/character-ar-config";
...
describe("AR handoff", () => {
  it("keeps a 20 cm plush independent of the character's life-size height", () => {
    expect(Object.keys(arCharacters).map((id) => arHeight(id as keyof typeof arCharacters, "plush"))).toEqual([.2, .2, .2, .2]);
